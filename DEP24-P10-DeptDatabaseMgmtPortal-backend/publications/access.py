...
# class PublicationAccessSpecifier(BaseAccessSpecifier):
#     model = Publication
...
#             return True
#         return self.user in publication.authors.all()
...
class PublicationAccessSpecifier(BaseAccessSpecifier):
    ...
    def get_object_owner_filter(self):
        return {'authors': self.user}
    
    def get_object_fa_filter(self):
        return {'authors__student_details__faculty_advisor': self.user}